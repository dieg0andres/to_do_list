...
from .views import my_auth_views, views, stripe_views
...
urlpatterns = [
    ...
    path('', my_auth_views.log_in, name='login'),
    path('signup/', my_auth_views.signup, name='signup'),
    path('login/', my_auth_views.log_in, name='login'),
    ...
    path('reset/<uidb64>/<token>', my_auth_views.CustomPasswordResetConfirmView.as_view(), name='password_reset_confirm'),
